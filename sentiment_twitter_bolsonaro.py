...
consumer_key='BTfRcpxCKQ5vtW5xZ88pjB42F'
consumer_secret='FISBIiC9UdiFjP3gJxDpGQFZtlz2jgQ81EkqfqbDAysNUa4X1Z'
access_token='56807090-zv6byTROoKMyuZFOIo23auuF4495JF8vTjHtUAHMR'
access_token_secret='K5w1HQmPQdvGjfWdPoQMYPPSngPbCC7g2Meqs34Zfx29r'
...
base_path = 'C:\\Users\\Diego Alves\\Desktop\\Data_sets\\ReLi-Lex'
train = []
wordsPT = []
wordsPT_sentiments = []
...
new_words = []
with open("C:\\Users\\Diego Alves\\Desktop\\Data_sets\\stopwords_portuguese.txt", 'r') as f:
...
twitter_mask = imread('C:\\Users\\Diego Alves\\Desktop\\Data_sets\\brasil_mask.png')
...
plt.axis("off")
plt.savefig('C:\\Users\\Diego Alves\\Desktop\\Data_sets\\lula-bolsonaro.png', dpi=300)
print(plt.show())
